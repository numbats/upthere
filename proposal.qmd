...
3.	Use PSM to match VFL(M/W) players who transition to AFL(M/W) with similar VFL(M/W) players who do not.
4.	Estimate the "treatment effect" of AFL(M/W) selection on subsequent performance outcomes, and test whether VFL(M/W) performance indicators predict AFL(M/W) success.
